...
const TRIGGERS = ["BOOKING_CREATED", "DEPOSIT_PAID", "DAYS_BEFORE_SHOOT", "SHOOT_COMPLETED", "PAYMENT_DUE_SOON", "PAYMENT_OVERDUE", "LEAD_INACTIVE"] as const;
const ACTIONS = ["SEND_CONFIRMATION", "SEND_QUESTIONNAIRE", "SEND_REMINDER", "SEND_THANK_YOU", "SEND_PAYMENT_REMINDER", "SEND_FOLLOW_UP"] as const;
const VARIABLES = ["name", "service", "date", "time", "amount", "business"];
