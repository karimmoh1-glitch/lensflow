...
const ProfileSchema = zod.object({
  name: zod.string().trim().min(1, "Enter your name.").max(80),
  workspaceName: zod.string().trim().min(1, "Give the workspace a name.").max(80),
  timezone: zod.string().trim().min(1).max(64),
});
