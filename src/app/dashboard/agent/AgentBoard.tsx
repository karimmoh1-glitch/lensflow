    ...
    <div className="space-y-8 dt-stagger">
      ...
      <section aria-label="What I can handle" className="rounded-[22px] border border-border bg-paper/60 px-5 py-4">
        ...
        <ul className="mt-2 grid sm:grid-cols-2 gap-x-6 gap-y-1.5 text-sm text-ink/75">
          ...
          <li className="sm:col-span-2 text-ink/55">I never send without approval, never mark anything sent that wasn&rsquo;t delivered, and never touch your calendars directly — those I point you to.</li>
        </ul>
      </section>

      {initial.activity.length > 0 && (
        <section>
          <h2 className="text-[11px] font-bold uppercase tracking-[0.14em] text-ink/50 mb-2.5 px-1">Assistant activity · last 7 days</h2>
