  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        className={cn(
          "w-11 h-6 rounded-full transition-colors duration-200 relative shrink-0 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/70 focus-visible:ring-offset-2",
