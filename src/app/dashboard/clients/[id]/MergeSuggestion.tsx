        ...
        {live.map((c) => (
          <li key={c.id} className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <div className="flex gap-2 shrink-0">
              <button type="button" disabled={pending} onClick={() => act(c, true)} className="h-9 px-3.5 rounded-lg bg-ink text-white text-xs font-bold disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/70">Merge into {name.split(" ")[0]}</button>
