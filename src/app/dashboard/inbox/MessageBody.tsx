    ...
    <div>
      ...
      {hasMore && (
        <button
          ...
          className={cn(
            "mt-2 inline-flex items-center gap-1 text-2xs font-semibold rounded-md px-1.5 py-0.5 -ml-1.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50",
