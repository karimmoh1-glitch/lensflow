  ...
  return (
    ...
    >
      <div>
        ...
        <p className="mt-0.5 text-xs text-ink/65">Signed in as {email}.</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {dirty && !pending && <button type="button" className="text-xs text-ink/60 hover:text-ink" onClick={() => setForm({ name, workspaceName, timezone })}>Reset</button>}
      </div>
    </form>
  );
}
