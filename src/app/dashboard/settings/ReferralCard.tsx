  ...
  return (
    <section aria-labelledby="referral-title" className="rounded-xl border border-border bg-white px-5 py-5">
      ...
      <div className="mt-4 flex flex-col sm:flex-row gap-2">
        ...
        <button type="button" onClick={copy} className="inline-flex items-center justify-center gap-2 h-11 px-4 rounded-lg bg-ink text-white text-sm font-bold hover:bg-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50">
