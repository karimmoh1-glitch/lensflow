        ...
        <div className="relative">
          <div className="rounded-[22px] border border-border bg-white shadow-[0_32px_80px_-32px_rgba(16,17,20,0.3)] overflow-hidden" style={{ opacity: arrive, transform: `translateY(${(1 - arrive) * 12}px)` }}>
                    ...
                    <div className="px-5 py-3.5">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="text-[10px] font-bold uppercase tracking-[0.12em] text-ink/65">{pr.kind}</div>
                      ...
                      {first && (
                        <div className="overflow-hidden" style={{ maxHeight: `${open * 200}px`, opacity: open }}>
                          <div className="mt-3 ml-11 rounded-xl border border-border bg-paper px-3.5 py-3">
                            <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.12em] text-ink/65 mb-1.5"><ChannelIcon k="instagram" size={14} />Draft · Instagram</div>
            ...
            <div className="px-5 py-3 border-t border-border bg-paper/60">
              <div className="text-[10px] font-bold uppercase tracking-[0.12em] text-ink/65 mb-1">Done today</div>
              ...
              <p className="text-[11px] text-ink/65 mt-1.5" style={{ opacity: 1 - done }}>Nothing here yet — approve something above.</p>
            </div>
          </div>
        </div>
      </div>
