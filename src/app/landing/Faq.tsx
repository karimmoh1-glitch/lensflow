...
export const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: "How does the subscription work?", a: "You start with no card, and with Pro free for your first month while Daythread is in beta. After that you stay on Free or subscribe to Pro. Billing is monthly or yearly (two months free) through Stripe; change or cancel any time from Settings → Subscription and you keep the plan until the period ends. Daythread never collects payments from your customers." },
