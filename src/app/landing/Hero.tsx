...
/**
 * The first viewport, painted from the server. Three seconds, no scrolling: what it is,
 * the channels flowing into one inbox, one button. The product is the larger half on
 * purpose — it's the thing being sold.
 */
export function Hero() {
  return (
    <div className="relative px-6 pt-8 md:pt-12 lg:pt-16 pb-16 md:pb-24 lg:min-h-[calc(84vh-72px)] flex items-start">
      <div className="w-full max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] gap-12 lg:gap-12 items-center">
        <div className="dt-hero-copy max-w-md">
          <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-ink/45 mb-6">One inbox for every message</p>
          <h1 className="font-sans font-extrabold text-[clamp(2.75rem,6vw,5.4rem)] leading-[0.92] tracking-[-0.05em] text-ink text-balance">
            Every message.<br /><span className="whitespace-nowrap">One thread.</span>
          </h1>
          <p className="mt-6 text-base md:text-lg text-ink/65 leading-relaxed max-w-sm">
            Instagram, Gmail, WhatsApp and texts in one inbox — sorted so the people waiting on you come first.
          </p>
          <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-3">
            ...
            >
              Create my inbox <span aria-hidden className="transition-transform duration-200 group-hover:translate-x-0.5">→</span>
            </Link>
            <span className="text-sm font-semibold text-ink/50">Free to start · no card</span>
          </div>
        </div>
