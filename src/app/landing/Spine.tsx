        ...
        {SCENES.map((s) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={cn(
                  "text-2xs font-bold uppercase tracking-[0.14em] whitespace-nowrap motion-safe:transition-all motion-safe:duration-300 group-focus-visible:opacity-100 group-focus-visible:translate-x-0",
