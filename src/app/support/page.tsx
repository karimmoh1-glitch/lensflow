  ...
  return (
    <main className="min-h-screen bg-paper">
      <div className="max-w-2xl mx-auto px-6 py-14 md:py-20">
        <Link href="/" className="inline-flex items-center gap-2 text-ink"><LogoMark className="w-5 h-5" /><span className="font-sans font-semibold text-[17px] tracking-tight">Daythread</span></Link>
        <h1 className="mt-8 font-sans font-semibold text-[2rem] md:text-[2.5rem] leading-[1.05] tracking-[-0.03em] text-ink">Support</h1>
