    ...
    <main className="min-h-screen bg-paper">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        {[
          ...
          ["Plans and billing", "Free, Pro ($20 per month) and Business ($50 per month) are the only plans. Paid plans are billed monthly through Stripe. You can change or cancel any time from Settings → Subscription; cancellation takes effect at the end of the paid period. Failed payments keep your plan active while Stripe retries; a lapsed subscription returns the workspace to Free without deleting data. Daythread does not process payments between you and your customers."],
          ...
          <section key={t} className="mt-8">
            <h2 className="text-sm font-bold uppercase tracking-[0.12em] text-ink/65">{t}</h2>
