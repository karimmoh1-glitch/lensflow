...
function ToastItem({ toast, onDone }: { toast: Toast; onDone: () => void }) {
  ...
  return (
    <div
      ...
      className={cn(
        "pointer-events-auto w-full md:w-auto md:min-w-[280px] md:max-w-[420px] flex items-start gap-3 rounded-xl border border-ink/10 bg-white/95 backdrop-blur px-4 py-3 shadow-[0_18px_44px_-20px_rgba(16,17,20,0.35)] transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
