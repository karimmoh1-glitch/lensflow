...
/** Personal mail providers: never a business's own domain, however the owner signs in. */
export const FREEMAIL = /^(gmail|googlemail|yahoo|outlook|hotmail|live|icloud|me|aol|proton|protonmail|pm|msn|comcast|att|verizon|sbcglobal|ymail)\.(com|net|me|ch)$/i;
